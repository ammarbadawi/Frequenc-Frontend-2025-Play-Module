...
import {
  CreatePopUp,
  CreateMatchPopUp,
} from "../components/createGame/createPopUp";

import Success from "../components/createGame/success";
const Marketplace = () => {
  const [isPopUpEnabled, setIsPopUpEnabled] = React.useState(false);
  ...
  return (
    <>
      <div>
        <section class="midshop">
          <div class="container">
            <div class="row">
              <div class="col-md-3">
                <div class="sidebarfil" onClick={() => setIsPopUpEnabled(true)}>
      ...
      {/* popUp for success */}
      {isSuccessPopUpEnabled && (
        <Success isSuccessPopUpEnabled={isSuccessPopUpEnabled} />
      )}
    </>
  );
};
